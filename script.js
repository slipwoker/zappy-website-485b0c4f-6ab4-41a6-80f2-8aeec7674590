document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input === messageInput && value.length < 10) {
        ...
        if (nameInput) {
            ...
            nameInput.addEventListener('input', function() { 
                if (nameInput.parentElement.querySelector('.error-message')) validateField(nameInput); 
            });
        }
        ...
        if (emailInput) {
            ...
            emailInput.addEventListener('input', function() { 
                if (emailInput.parentElement.querySelector('.error-message')) validateField(emailInput); 
            });
        }
        
        if (messageInput) {
            messageInput.addEventListener('blur', function() { validateField(messageInput); });
            messageInput.addEventListener('input', function() { 
                if (messageInput.parentElement.querySelector('.error-message')) validateField(messageInput); 
            });
        }
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #38a169; font-size: 1rem; margin-top: 1rem; padding: 1rem; background: #f0fff4; border-radius: 0.25rem;';
                ...
                .catch(function() {
                    ...
                    errorMessage.style.cssText = 'color: #e53e3e; font-size: 1rem; margin-top: 1rem; padding: 1rem; background: #fff5f5; border-radius: 0.25rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '485b0c4f-6ab4-41a6-80f2-8aeec7674590',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '485b0c4f-6ab4-41a6-80f2-8aeec7674590';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '485b0c4f-6ab4-41a6-80f2-8aeec7674590';
